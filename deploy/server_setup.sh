# @Author: Carlo Carpio
# @Date:   2017-10-08 10:24:50
# @Last Modified by:   Carlo Carpio
# @Last Modified time: 2017-10-08 10:25:15

#!/usr/bin/env bash

# TODO: Set to URL of git repo.
PROJECT_GIT_URL='https://github.com/blouiecubero/django-rest-api-test.git'
